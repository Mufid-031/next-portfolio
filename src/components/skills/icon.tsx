  ...
  return (
    <div className="flex justify-between items-center w-full h-[150px] -z-10">
      <motion.div
        ...
        className={`w-[50px] h-[50px] md:w-[80px] md:h-[80px] rounded-full relative flex justify-center items-center ${
          darkMode ? (hoverOne === "white" ? "bg-[#0d0d0d]" : "bg-[#ecebeb]") : hoverOne === "black" ? "bg-[#ecebeb]" : "bg-[#0d0d0d]"
        }`}
      >
